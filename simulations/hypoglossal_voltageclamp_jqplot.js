...
window.addEventListener('load', function () {
    ...
    paramsNeonatalSim = { 
        ...
        holdingPotential_mV: { label: 'Holding potential', units: 'mV', 
            defaultVal: -70, minVal: -200, maxVal: 200 },
        stepPotential_mV: { label: 'First step potential', units: 'mV', 
            defaultVal: 0, minVal: -200, maxVal: 200 },
    ...
    paramsAdultSim = JSON.parse(JSON.stringify(paramsNeonatalSim));
    paramsAdultSim.g_K_uS.defaultVal = 2.6;
    paramsAdultSim.g_A_uS.defaultVal = 2.0;
    paramsAdultSim.g_H_uS.defaultVal = 0.05;
    ...
    controlsPanel = document.getElementById('HypoglossalControls');

    // prepare tables for displaying captured data points
    dataPanel = document.getElementById('HypoglossalData');
    ...
    function runSimulation() {
        ...
        // plot the results
        plotPanel = document.getElementById('HypoglossalPlots');
        plotPanel.innerHTML = '';
    ...
    (document.getElementById('HypoglossalRunButton')
        .addEventListener('click', runSimulation, false));
    (document.getElementById('HypoglossalNeonatalSimButton')
        .addEventListener('click', resetToNeonatalSim, false));
    (document.getElementById('HypoglossalAdultSimButton')
        .addEventListener('click', resetToAdultSim, false));
    (document.getElementById('HypoglossalClearDataButton')
