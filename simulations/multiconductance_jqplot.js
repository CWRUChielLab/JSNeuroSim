...
window.addEventListener('load', function () {
    ...
    function runSimulation() {
        ...
        plotPanel.appendChild(plot);
        plotHandles.push(
            $.jqplot('currentPlot', [iLeak_nA, iHHK_nA], jQuery.extend(true, {}, graphJqplot.defaultOptions(params), {
                legend: {show: true},
                axes: {
                    xaxis: {label:'Time (ms)'},
        ...
        plotPanel.appendChild(plot);
        plotHandles.push(
            $.jqplot('conductancePlot', [gHHK_uS], jQuery.extend(true, {}, graphJqplot.defaultOptions(params), {
                legend: {show: true},
                axes: {
                    xaxis: {label:'Time (ms)'},
        ...
        plotPanel.appendChild(plot);
        plotHandles.push(
            $.jqplot('gatePlot', [nGate], jQuery.extend(true, {}, graphJqplot.defaultOptions(params), {
                legend: {show: true},
                axes: {
                    xaxis: {label:'Time (ms)'},
                    yaxis: {
