...
window.addEventListener('load', function () {
    ...
    layout = [
        ...
        ['Synapse properties', [ 'g_normalized_syn_uS', 'E_rev_syn_mV', 'tau_r_ms',
            'tau_d_ms', 'Ca_facilitation_nM', 'V_thresh_mV', 'K_p']],
    ...
    (document.getElementById('SynapseCurrentClampPlasticResetButton')
