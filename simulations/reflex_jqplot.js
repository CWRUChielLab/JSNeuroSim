...
//	var
	...
	layout = [
		...
		['Spindle Fiber Neuron Properties', ['spindle_V_init_mV', 'spindle_C_nF', 'spindle_g_leak_uS', 'spindle_E_leak_mV',
    ...
    function downloadSVG() {
        var svgString, a, blob;

        svgString = paper.toSVG();
        a = document.createElement('a');
        animationPanel.appendChild(a);
        a.download = 'reflex-animation.svg';
    ...
    // Comment out this line to show the "Download SVG" button
	...
	(document.getElementById('DownloadSVGButton')
		.addEventListener('click', downloadSVG, false));
